          ...
          <div className="flex items-end justify-between mt-3">
            ...
            >
              {!cartItems[product._id] ? (
                <button
                  className="flex items-center justify-center gap-1 bg-secondary border border-primary/50 md:w-20 w-16 h-[34px] rounded text-primary font-medium"
                  onClick={() => {
                ...
                <div className="flex items-center justify-center gap-2 md:w-20 w-16 h-[34px] bg-secondary rounded select-none">
                  ...
                  <span className="w-5 text-center text-primary">
                    {cartItems[product._id]}
                  </span>
                  <button
